...
const EkspertizRandevuOdeme3D = ({ navigation, screenProps, route }) => {
  ...
  //   navigation.getParam('data').htmlContent,
  // );
  const [htmlContent, setHtmlContent] = useState(
    route.params.data.htmlContent,
  );
...
export default EkspertizRandevuOdeme3D;
