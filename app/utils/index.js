...
import {join, ifElse, map, identity, curry} from 'ramda';
...
//joinErrors::object[Array[string]] => Object[string]
export const joinErrors = map(ifElse(Array.isArray, join(', '), identity));
export const genWithCallback = curry((fn, resolve, reject, payload) =>
